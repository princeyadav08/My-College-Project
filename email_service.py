...
SMTP_PORT = 587
SENDER_EMAIL = "yadavprince773899@gmail.com"
SENDER_PASSWORD = "yiix mvbr ajdi bsmg"  # Aapka App Password

def send_real_otp(receiver_email):
    """Real 6-digit OTP generate karke user ke email par send karta hai"""
    ...
    <div style="font-family: Arial, sans-serif; background-color: #0f172a; color: #ffffff; padding: 25px; border-radius: 12px; max-width: 480px; margin: auto;">
        ...
        <p style="color: #cbd5e1; font-size: 14px;">Aapka verification OTP neeche diya gaya hai:</p>
        ...
        <p style="font-size: 12px; color: #94a3b8; text-align: center;">Yeh code agle 10 minute tak valid hai.</p>
    </div>
    """
...
def send_inquiry_confirmation(receiver_email, user_name):
    """Inquiry confirmation email dispatch karta hai"""
    msg = MIMEMultipart("alternative")
    ...
    <div style="font-family: Arial, sans-serif; padding: 20px; color: #1e293b;">
        ...
        <p>Hamari team jaldi hi aapse sampark karegi.</p>
        <br>
